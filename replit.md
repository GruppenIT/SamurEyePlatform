...
- **CVE Detection Service**: Integrates with NIST NVD for real-time, intelligent CVE analysis, including version-aware filtering, Windows version extraction, version range comparison, and confidence scoring to prevent false positives.
